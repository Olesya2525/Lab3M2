...
const owner: IOwner = new Owner("Рябец", "Олеся", "Валерьевна", new Date(), Docs.PASSPORT, 12121, 244444);
...
const owner1: IOwner = new Owner("Пупкин", "Василий", "Абрамович", new Date(), Docs.POLIC, 77777, 777777);
